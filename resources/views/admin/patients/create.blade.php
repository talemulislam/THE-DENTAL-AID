    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.patients.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('optional_phone') ? 'is-invalid' : '' }}" type="text" name="optional_phone" id="optional_phone" value="{{ old('optional_phone', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('emergency_contact_person') ? 'is-invalid' : '' }}" type="text" name="emergency_contact_person" id="emergency_contact_person" value="{{ old('emergency_contact_person', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('emergency_phone') ? 'is-invalid' : '' }}" type="text" name="emergency_phone" id="emergency_phone" value="{{ old('emergency_phone', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('emergency_email') ? 'is-invalid' : '' }}" type="email" name="emergency_email" id="emergency_email" value="{{ old('emergency_email') }}">
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('city') ? 'is-invalid' : '' }}" name="city" id="city">
                    ...
                    @foreach(App\Patient::CITY_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('city', '0') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
                @if($errors->has('city'))
                    <div class="invalid-feedback">
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('permanent_city') ? 'is-invalid' : '' }}" name="permanent_city" id="permanent_city">
                    ...
                    @foreach(App\Patient::PERMANENT_CITY_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('permanent_city', '0') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('no_of_family_member') ? 'is-invalid' : '' }}" type="number" name="no_of_family_member" id="no_of_family_member" value="{{ old('no_of_family_member', '1') }}" step="1">
